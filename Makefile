...
#    Updated: 2022/02/28 21:17:15 by ple-stra         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS		= main.c parse_map.c errors.c debug.c free.c display_map.c\
 keys_events.c keys_events_arrows.c keys_events_plus_minus.c key_modes.c\
 mlx_utils.c img_garbage.c draw.c draw_utils.c 3d_world.c
BUILD_DIR	= build
